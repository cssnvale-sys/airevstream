...
export async function GET(req: NextRequest) {
  ...
  const rl = checkRateLimit(`analytics-content-performance:${ip}:${ctx.userId}`, RATE_LIMITS.standardRead);
  ...
  try {
    ...
    logger.error('GET /api/v1/analytics/content-performance error', err as Error);
