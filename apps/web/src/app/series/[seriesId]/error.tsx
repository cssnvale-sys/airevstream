  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-lg font-semibold text-text-primary mb-2">Series Error</h2>
        <p className="text-sm text-text-secondary mb-6">
          Something went wrong loading this series. It may not exist or there was a server error.
        </p>
        <div className="flex items-center justify-center gap-3">
          ...
          <Link href="/series" className="btn-secondary inline-flex items-center gap-2">
            <ArrowLeft size={16} />
            Back to Series
          </Link>
        </div>
