...
export function GenerationStatus({ jobId, onComplete }: GenerationStatusProps) {
  ...
  if (status === 'completed') {
    return (
      <div role="status" className="flex items-center gap-2 text-accent-green">
  ...
  if (status === 'failed') {
    return (
      <div role="status" className="flex items-center gap-2 text-accent-red">
        <AlertCircle size={16} />
  ...
  return (
    <div role="status" className="flex items-center gap-2 text-accent-blue">
