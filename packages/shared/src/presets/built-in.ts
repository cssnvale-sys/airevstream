...
export const VISUAL_PRESETS: Preset[] = [
  ...
  {
    id: 'visual.neon-synthwave.v1',
    name: 'Neon Synthwave',
    family: 'visual',
    description: 'Saturated pinks and purples with high contrast 80s retro aesthetic',
    tags: ['synthwave', 'retro', 'neon', '80s', 'vaporwave'],
    builtIn: true,
    overrides: {
      colorGrade: { saturation: 55, contrast: 35, tint: -25, temperature: -10, highlights: 15 },
      postProcess: { filmGrain: 8, sharpen: 15 },
      generation: { steps: 30, cfg: 7.5, sampler: 'dpmpp_2m', scheduler: 'karras' },
      negativePrompt: 'natural, desaturated, muted, earthy',
    },
    ranges: { 'colorGrade.saturation': { min: 35, max: 70 }, 'colorGrade.contrast': { min: 20, max: 50 } },
  },
  {
    id: 'visual.documentary-newsreel.v1',
    name: 'Documentary Newsreel',
    family: 'visual',
    description: 'Desaturated journalistic look with understated credibility',
    tags: ['documentary', 'newsreel', 'journalism', 'realistic'],
    builtIn: true,
    overrides: {
      colorGrade: { saturation: -25, contrast: 10, temperature: -5, shadows: -5 },
      postProcess: { filmGrain: 12, sharpen: 25 },
    },
    ranges: { 'colorGrade.saturation': { min: -40, max: -10 } },
  },
  {
    id: 'visual.pastel-illustration.v1',
    name: 'Pastel Illustration',
    family: 'visual',
    description: 'Soft pastel colors with painterly flat design aesthetic',
    tags: ['pastel', 'illustration', 'flat', 'painterly', 'soft'],
    builtIn: true,
    overrides: {
      colorGrade: { saturation: 15, contrast: -20, temperature: 5, highlights: 20 },
      generation: { steps: 30, cfg: 8, sampler: 'dpmpp_2m', scheduler: 'karras' },
      negativePrompt: 'photorealistic, gritty, dark, harsh shadows',
    },
  },
  {
    id: 'visual.underwater-dreamy.v1',
    name: 'Underwater Dreamy',
    family: 'visual',
    description: 'Blue-green color shift with light scattering for ethereal underwater feel',
    tags: ['underwater', 'ethereal', 'blue', 'aquatic'],
    builtIn: true,
    overrides: {
      colorGrade: { tint: -20, temperature: -15, saturation: -5, contrast: -10, highlights: 10 },
      postProcess: { vignette: 15 },
      lighting: 'dappled caustic light, underwater volumetric rays',
      generation: { steps: 30, cfg: 7, sampler: 'dpmpp_2m', scheduler: 'karras' },
      negativePrompt: 'dry land, desert, fire, warm tones',
    },
    ranges: { 'colorGrade.tint': { min: -35, max: -5 }, 'colorGrade.temperature': { min: -25, max: -5 } },
  },
  {
    id: 'visual.horror-atmospheric.v1',
    name: 'Horror Atmospheric',
    family: 'visual',
    description: 'Extreme contrast with desaturation and heavy shadows for horror',
    tags: ['horror', 'dark', 'atmospheric', 'creepy'],
    builtIn: true,
    overrides: {
      colorGrade: { contrast: 45, saturation: -40, temperature: -15, shadows: -35, highlights: -15 },
      postProcess: { filmGrain: 25, vignette: 30 },
      generation: { steps: 35, cfg: 8, sampler: 'dpmpp_2m', scheduler: 'karras' },
      negativePrompt: 'bright, cheerful, colorful, comedy, sunshine',
    },
    ranges: { 'colorGrade.contrast': { min: 30, max: 60 }, 'colorGrade.shadows': { min: -50, max: -20 } },
  },
  {
    id: 'visual.anime-cel-shaded.v1',
    name: 'Anime Cel-Shaded',
    family: 'visual',
    description: 'Bold outlines with flat color and high saturation anime style',
    tags: ['anime', 'cel-shaded', 'cartoon', 'bold', 'japanese'],
    builtIn: true,
    overrides: {
      colorGrade: { saturation: 45, contrast: 25, highlights: 15 },
      postProcess: { sharpen: 30 },
      generation: { steps: 30, cfg: 8, sampler: 'dpmpp_2m', scheduler: 'karras' },
      negativePrompt: 'photorealistic, soft focus, film grain, muted colors',
    },
    ranges: { 'colorGrade.saturation': { min: 30, max: 60 } },
  },
  {
    id: 'visual.nordic-minimal.v1',
    name: 'Nordic Minimal',
    family: 'visual',
    description: 'Cool tones with clean airy high-key lighting',
    tags: ['nordic', 'minimal', 'clean', 'cool', 'scandinavian'],
    builtIn: true,
    overrides: {
      colorGrade: { temperature: -10, saturation: -15, contrast: -5, highlights: 25 },
      lighting: 'soft overcast, high key, diffused natural light',
    },
    ranges: { 'colorGrade.highlights': { min: 10, max: 35 } },
  },
  {
    id: 'visual.desert-cinematic.v1',
    name: 'Desert Cinematic',
    family: 'visual',
    description: 'Warm oranges and sand tones with Villeneuve-inspired aesthetic',
    tags: ['desert', 'cinematic', 'warm', 'sand', 'villeneuve'],
    builtIn: true,
    overrides: {
      colorGrade: { temperature: 30, saturation: -10, contrast: 20, shadows: -15 },
      postProcess: { filmGrain: 10, vignette: 12 },
      lighting: 'harsh directional sunlight, long shadows, dust particles',
      generation: { steps: 32, cfg: 7.5, sampler: 'dpmpp_2m', scheduler: 'karras' },
      negativePrompt: 'green, lush, tropical, rain, overcast',
    },
    ranges: { 'colorGrade.temperature': { min: 20, max: 40 } },
  },
];
...
export const CAMERA_PRESETS: Preset[] = [
  ...
  {
    id: 'camera.macro-insert.v1',
    name: 'Macro Insert',
    family: 'camera',
    description: 'Extreme close-up with 100mm+ for product and detail shots',
    tags: ['macro', 'close-up', 'detail', 'product', 'insert'],
    builtIn: true,
    overrides: {
      camera: { lens: '100mm macro', framing: 'extreme-close-up', dof: 'ultra-shallow', movement: 'static' },
    },
  },
  {
    id: 'camera.dutch-angle.v1',
    name: 'Dutch Angle',
    family: 'camera',
    description: 'Tilted 15-30 degree framing for tension and unease',
    tags: ['dutch', 'tilted', 'tension', 'dramatic', 'unease'],
    builtIn: true,
    overrides: {
      camera: { lens: '35mm', framing: 'medium', dof: 'medium', movement: 'static', tilt: 20 },
    },
  },
  {
    id: 'camera.crane-reveal.v1',
    name: 'Crane Reveal',
    family: 'camera',
    description: 'High-angle descending to eye-level for dramatic reveals',
    tags: ['crane', 'reveal', 'high-angle', 'dramatic', 'descending'],
    builtIn: true,
    overrides: {
      camera: { lens: '35mm', framing: 'wide', dof: 'deep', movement: 'crane-down', stabilization: 'gimbal' },
    },
  },
  {
    id: 'camera.whip-pan.v1',
    name: 'Whip Pan',
    family: 'camera',
    description: 'Rapid horizontal pan with motion blur for energetic transitions',
    tags: ['whip-pan', 'fast', 'energetic', 'transition', 'motion-blur'],
    builtIn: true,
    overrides: {
      camera: { lens: '24mm', framing: 'wide', dof: 'deep', movement: 'whip-pan', stabilization: 'handheld' },
    },
  },
];
...
export const AUDIO_PRESETS: Preset[] = [
  ...
  {
    id: 'audio.lofi-chill.v1',
    name: 'Lo-Fi Chill',
    family: 'audio',
    description: 'Soft beats with vinyl crackle and ambient bed for relaxed tone',
    tags: ['lofi', 'chill', 'relaxed', 'ambient', 'vinyl'],
    builtIn: true,
    overrides: {
      audioPlan: {
        bg: { source: 'generate', volume: 0.25, loop: true, fadeInMs: 3000, fadeOutMs: 3000, levelDb: -22 },
        fg: { source: 'tts', volume: 0.85, levelDb: -12, duckingDb: -6 },
      },
    },
  },
  {
    id: 'audio.tech-science.v1',
    name: 'Tech / Science',
    family: 'audio',
    description: 'Modular synth bleeps with digital textures for tech content',
    tags: ['tech', 'science', 'digital', 'synth', 'futuristic'],
    builtIn: true,
    overrides: {
      audioPlan: {
        bg: { source: 'generate', volume: 0.2, loop: true, fadeInMs: 1500, fadeOutMs: 1500, levelDb: -26 },
        fg: { source: 'tts', volume: 0.9, levelDb: -10, duckingDb: -8 },
      },
    },
  },
  {
    id: 'audio.asmr-nature.v1',
    name: 'ASMR Nature',
    family: 'audio',
    description: 'Binaural nature sounds with whisper-level narration',
    tags: ['asmr', 'nature', 'binaural', 'whisper', 'gentle'],
    builtIn: true,
    overrides: {
      audioPlan: {
        bg: { source: 'generate', volume: 0.3, loop: true, fadeInMs: 4000, fadeOutMs: 4000, levelDb: -20 },
        fg: { source: 'tts', volume: 0.7, levelDb: -14, duckingDb: -4 },
      },
    },
  },
  {
    id: 'audio.hiphop-beat.v1',
    name: 'Hip-Hop Beat',
    family: 'audio',
    description: '808s and trap hi-hats with rhythmic narration pacing',
    tags: ['hiphop', 'trap', '808', 'rhythmic', 'beat'],
    builtIn: true,
    overrides: {
      audioPlan: {
        bg: { source: 'generate', volume: 0.35, loop: true, levelDb: -16 },
        fg: { source: 'tts', volume: 0.85, levelDb: -10, duckingDb: -10 },
      },
    },
  },
...
export const OUTPUT_PRESETS: Preset[] = [
  ...
  {
    id: 'output.4k-ultra.v1',
    name: '4K Ultra',
    family: 'output',
    description: '3840x2160, 30fps, h264, high bitrate for premium quality',
    tags: ['4k', 'uhd', 'premium', 'high-quality'],
    builtIn: true,
    tier: 'advanced',
    overrides: {
      generation: { width: 3840, height: 2160 },
      fps: 30,
      aspect: '16:9',
      codec: 'h264',
    },
  ...
  {
    id: 'output.mobile-stories.v1',
    name: 'Mobile Stories',
    family: 'output',
    description: '1080x1920, 15fps, h264, optimized for low-bandwidth mobile stories',
    tags: ['mobile', 'stories', 'low-bandwidth', 'portrait'],
    builtIn: true,
    overrides: {
      generation: { width: 1080, height: 1920 },
      fps: 15,
  ...
  {
    id: 'output.square-instagram.v1',
    name: 'Square Instagram',
    family: 'output',
    description: '1080x1080, 30fps, h264 optimized for Instagram feed posts',
    tags: ['instagram', 'square', 'feed', '1:1'],
    builtIn: true,
    overrides: {
      generation: { width: 1080, height: 1080 },
      fps: 30,
...
export const MASTER_BUNDLES: Recipe[] = [
  ...
  // ── New Recipes ──
  {
    id: 'recipe.shorts.asmr-nature.v1',
    name: 'ASMR Nature',
    description: 'Ethereal underwater visuals with ASMR nature audio and macro inserts',
    tags: ['asmr', 'nature', 'underwater', 'macro', 'gentle'],
    builtIn: true,
    category: 'shorts',
    mood: 'ASMR Nature',
    tier: 'simple',
    directives: { targetShotCount: 6, avgShotLengthSec: 5, pacing: 'slow', dialogueDensity: 'sparse', lensPackage: 'standard-mix', narrativeStructure: 'montage', seedPolicy: 'free' },
    routing: DEFAULT_ROUTING,
    constraints: SHORTS_CONSTRAINTS,
    presetIds: [
      'visual.underwater-dreamy.v1',
      'camera.macro-insert.v1',
      'audio.asmr-nature.v1',
      'edit.slow-burn.v1',
      'story.montage.v1',
      'character.no-dialogue.v1',
      'output.reels-portrait.v1',
  ...
  {
    id: 'recipe.one-off.tech-review.v1',
    name: 'Tech Review',
    description: 'Clean Nordic minimal visuals with tech audio for product and science reviews',
    tags: ['tech', 'review', 'science', 'clean', 'product'],
    builtIn: true,
    category: 'one-off',
    mood: 'Tech Review',
    tier: 'simple',
    directives: { targetShotCount: 8, avgShotLengthSec: 4, pacing: 'moderate', dialogueDensity: 'dense', lensPackage: 'standard-mix', narrativeStructure: 'hicc', seedPolicy: 'scene-lock' },
    routing: DEFAULT_ROUTING,
    constraints: ONE_OFF_CONSTRAINTS,
    presetIds: [
      'visual.nordic-minimal.v1',
      'camera.static-fifty.v1',
      'audio.tech-science.v1',
      'story.hicc-standard.v1',
      'character.solo-speaker.v1',
      'output.youtube-landscape.v1',
    ],
  ...
  {
    id: 'recipe.cinematic.horror.v1',
    name: 'Horror Short',
    description: 'Atmospheric horror with dutch angles, suspense audio, and twist narrative',
    tags: ['horror', 'suspense', 'dark', 'atmospheric', 'twist'],
    builtIn: true,
    category: 'cinematic',
    mood: 'Horror',
    tier: 'simple',
    directives: { targetShotCount: 8, avgShotLengthSec: 4, pacing: 'moderate', dialogueDensity: 'sparse', lensPackage: 'portrait-heavy', narrativeStructure: 'setup-twist', seedPolicy: 'series-lock' },
    routing: CINEMATIC_ROUTING,
    constraints: CINEMATIC_CONSTRAINTS,
    presetIds: [
      'visual.horror-atmospheric.v1',
      'camera.dutch-angle.v1',
      'audio.tense-suspense.v1',
      'story.setup-twist.v1',
      'character.solo-speaker.v1',
      'output.youtube-landscape.v1',
  ...
  {
    id: 'recipe.shorts.anime-highlight.v1',
    name: 'Anime Highlight',
    description: 'Bold anime visuals with energetic beat and rapid whip-pan montage',
    tags: ['anime', 'energetic', 'highlight', 'montage', 'bold'],
    builtIn: true,
    category: 'shorts',
    mood: 'Anime Highlight',
    tier: 'simple',
    directives: { targetShotCount: 6, avgShotLengthSec: 2.5, pacing: 'frenetic', dialogueDensity: 'sparse', lensPackage: 'standard-mix', narrativeStructure: 'montage', seedPolicy: 'free' },
    routing: DEFAULT_ROUTING,
    constraints: SHORTS_CONSTRAINTS,
    presetIds: [
      'visual.anime-cel-shaded.v1',
      'camera.whip-pan.v1',
      'audio.hiphop-beat.v1',
      'edit.montage.v1',
      'story.montage.v1',
      'character.faceless-cinema.v1',
      'output.reels-portrait.v1',
