...
import type { UltrawideCinemaProps, CinemaShotData, TextOverlayConfig } from '../types';
...
/**
 * UltrawideCinema — 21:9 ultrawide cinematic video composition (2560x1080, 24fps)
 *
 * Premium cinematic format for theatrical-style content. Features all the
 * capabilities of CinemaVideo plus thin letterbox bars for an authentic
 * widescreen cinematic feel.
 *
 * Features:
 * - 24fps cinema standard
 * - 21:9 ultrawide aspect ratio (2560x1080)
 * - Letterbox bars (thin black bars top/bottom)
 ...
 */
export const UltrawideCinema: React.FC<UltrawideCinemaProps> = ({
  shots,
  audioTracks,
  width,
  height,
  ...
  return (
    ...
    >
      ...
      {/* Letterbox bars — thin black bars top/bottom for cinematic feel */}
      <LetterboxBars width={width} height={height} barHeight={letterboxHeight} />
...
const CinemaShot: React.FC<{
  ...
  width: number;
  height: number;
  globalColorGrade?: UltrawideCinemaProps['colorGrade'];
...
/**
 * Letterbox bars — thin black bars at the top and bottom of the frame
 * for an authentic cinematic widescreen feel.
 */
const LetterboxBars: React.FC<{
  width: number;
  height: number;
  barHeight: number;
}> = ({ width, height: _height, barHeight }) => (
  <>
    {/* Top bar */}
    <div
      style={{
...
const WatermarkRenderer: React.FC<{
  config: NonNullable<UltrawideCinemaProps['watermark']>;
  width: number;
  height: number;
